...
@RestController
public class CpcCompanyEmployeeController {

	private static final Logger logger = Logger.getLogger(CpcCompanyEmployeeController.class);

	@Autowired
	private CpcCompanyEmployeeService cpcCompanyEmployeeService;
	...
	public CpcCompanyEmployee save() {
		...
		try {
			...
			cpcCompanyEmployee = cpcCompanyEmployeeService.save(cpcCompanyEmployee);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public List<CpcCompanyEmployee> saveList() {
		...
		try {
			...
			list = cpcCompanyEmployeeService.saveList(list);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return list;
	...
	public CpcCompanyEmployee update() {
		...
		try {
			...
			cpcCompanyEmployee = cpcCompanyEmployeeService.update(100000000L);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return cpcCompanyEmployee;
	...
	public List<CpcCompanyEmployee> updateList() {
		...
		try {
			...
			list = cpcCompanyEmployeeService.updateList(l);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return list;
	...
	public CpcCompanyEmployee findById() {
		...
		try {
			...
			cpcCompanyEmployee = cpcCompanyEmployeeService.findById(100000000L);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return cpcCompanyEmployee;
	...
	public List<CpcCompanyEmployee> findList() {
		...
		try {
			...
			l.add(200000000L);
			l.add(300000000L);
			list = cpcCompanyEmployeeService.findList(l);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return list;
	...
	public /* Page<CpcCompanyEmployee> */List<CpcCompanyEmployee> page() {
		...
		try {
			...
			page = cpcCompanyEmployeeService.page(map);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return page;
	...
	public void delete() {
		try {
			...
			cpcCompanyEmployeeService.delte(100000000L);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return;
	...
	public void deleteList() {
		try {
			...
			list.add(200000000L);
			list.add(300000000L);
			cpcCompanyEmployeeService.deleteList(list);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return;
